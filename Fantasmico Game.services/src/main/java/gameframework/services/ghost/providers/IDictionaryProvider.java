...
/**
 * This interfaces provides information to check letters, words and conditions to finish a ghost game.
 * 
...
{
    /**
     * This method checks whether the concrete dictionary provider is linked with the specified language code.
     * 
     * @param lang
     * @return
     */
